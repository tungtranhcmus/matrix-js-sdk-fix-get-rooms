...
var conversationsFilter = 0
function getConversationsFilter (){
  return conversationsFilter
}
exports.getConversationsFilter = getConversationsFilter
var _exportNames = {
  request: true,
  getRequest: true,
  wrapRequest: true,
...
function createClient(opts) {
  ...
  conversationsFilter = opts.conversationsFilter
  console.tron.log('opts.conversationsFilter',opts.conversationsFilter);
